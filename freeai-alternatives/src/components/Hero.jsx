...
export default function Hero({ onSearch }) {
  return (
    <section id="home" className="relative overflow-hidden pt-36 pb-24 sm:pt-44 sm:pb-32">
      <div className="pointer-events-none absolute -top-32 left-1/2 h-[420px] w-[860px] -translate-x-1/2 rounded-full bg-gradient-to-br from-brand-300/25 via-violet-300/20 to-cyan-300/20 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 -left-32 h-72 w-72 rounded-full bg-cyan-300/15 blur-3xl" />
      <div className="pointer-events-none absolute -right-32 top-40 h-72 w-72 rounded-full bg-violet-300/15 blur-3xl" />
      ...
      <div className="pointer-events-none absolute left-[8%] top-1/2 hidden -translate-y-1/2 lg:block">
        <div className="animate-float-slow card flex items-center gap-3 rounded-2xl px-4 py-3 shadow-hero-card">
          <span className="tile h-9 w-9 rounded-lg bg-gradient-to-br from-cyan-400 to-sky-500 text-[11px] font-bold text-white">
            DS
          </span>
          <div>
      ...
      <div className="pointer-events-none absolute right-[7%] top-1/3 hidden -translate-y-1/2 lg:block">
        <div className="animate-float-slower card flex items-center gap-3 rounded-2xl px-4 py-3 shadow-hero-card">
          <span className="tile h-9 w-9 rounded-lg bg-gradient-to-br from-indigo-500 to-violet-500 text-[11px] font-bold text-white">
            GM
          </span>
          <div>
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6">
        <p className="animate-fade-up mx-auto mb-7 inline-flex items-center gap-2 rounded-full border border-slate-200/90 bg-white/90 px-4 py-1.5 text-xs font-semibold text-slate-600 shadow-soft dark:border-white/10 dark:bg-white/5 dark:text-slate-300">
        ...
        <dl
          className="animate-fade-up mx-auto mt-12 grid max-w-xl grid-cols-3 divide-x divide-slate-200 rounded-2xl border border-slate-200/80 bg-white/80 py-4 shadow-soft dark:divide-white/10 dark:border-white/10 dark:bg-white/5"
